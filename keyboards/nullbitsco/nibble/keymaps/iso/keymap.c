...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_MA] = LAYOUT_iso(
    ...
    KC_F13,  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,          KC_HOME,
  ...
  [_FN] = LAYOUT_iso(
    ...
    _______, _______, _______, _______,                            KC_MPLY,                   _______, _______, _______, KC_MPRV, KC_MSTP , KC_MNXT
  ),
